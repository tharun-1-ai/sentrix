...
import { Lock, Eye, EyeOff, KeyRound, CheckCircle2, Shield } from "lucide-react";
...
const strengthColors = [
  "bg-destructive", "bg-destructive", "bg-yellow-500", "bg-yellow-400", "bg-green-500", "bg-green-400",
];
  ...
  return (
    <>
      <div className="cyber-card p-5 space-y-4">
        ...
        >
          <div className="flex items-center gap-3">
            <KeyRound className="h-5 w-5 text-primary" style={{ filter: "drop-shadow(0 0 8px hsl(var(--primary) / 0.3))" }} />
          ...
          <form onSubmit={handleChangePassword} className="space-y-4 pt-4 border-t border-border animate-fade-in">
            <div>
              ...
              <div className="relative">
                ...
                <input type={showCurrent ? "text" : "password"} value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} className={inputClass} placeholder={t("currentPassword")} required />
            ...
            <button
              ...
              className="w-full py-2.5 bg-primary text-primary-foreground rounded-md text-sm font-display font-bold tracking-wide hover:shadow-[0_0_20px_hsl(var(--primary)/0.3)] transition-all disabled:opacity-50"
            >
      ...
      <div className="cyber-card p-5">
        <div className="flex items-center gap-3">
          <Shield className="h-8 w-8 text-primary" style={{ filter: "drop-shadow(0 0 10px hsl(var(--primary) / 0.3))" }} />
          <div>
            <p className="font-display font-bold text-sm">Sentrix Security</p>
            <p className="text-xs text-muted-foreground font-medium">{t("securityCardDesc")}</p>
          </div>
        </div>
      </div>
    </>
